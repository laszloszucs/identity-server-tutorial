...
class LocalStoreManager {
  ...
  //   private initEvent = new Subject(); // TODO Observable helyett mit lehet itt??
  ...
  //   public getInitEvent(): Observable<{}> { // TODO Observable helyett mit lehet itt??
  ...
  private sessionStorageTransferHandler = (event: StorageEvent) => {
    ...
    if (event.key == "getSessionStorage") {
      ...
      //   this.onInit(); // TODO Observable helyett mit lehet itt??
  ...
  //   private onInit() {  // TODO Observable helyett mit lehet itt??
  //     setTimeout(() => {
  //       this.initEvent.next();
